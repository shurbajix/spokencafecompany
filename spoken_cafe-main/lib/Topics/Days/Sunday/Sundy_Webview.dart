...
class SundyWebview extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SundyWebview> createState() => _SundyWebViewState();
}

class _SundyWebViewState extends ConsumerState<SundyWebview> {
  double _progress = 0;
...
List<String> linkformonday = [
  'https://www.englishspokencafe.com/junior-isleyis/',
  'https://www.englishspokencafe.com/junior-isleyis/',
  'https://www.englishspokencafe.com/junior-isleyis/',
];
