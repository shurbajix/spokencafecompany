...
class ThursdayWebview extends ConsumerStatefulWidget {
  final int index; // Add an index parameter
  final int indexlevel;

  const ThursdayWebview({
    super.key,
  ...
  @override
  ConsumerState<ThursdayWebview> createState() => _ThursdayWebViewState();
}

class _ThursdayWebViewState extends ConsumerState<ThursdayWebview> {
  double _progress = 0;
