...
class WeekendWebview extends ConsumerStatefulWidget {
  final int index; // Add an index parameter
  final int indexlevel;

  const WeekendWebview({
    super.key,
  ...
  @override
  ConsumerState<WeekendWebview> createState() => _WeekendWebViewState();
}

class _WeekendWebViewState extends ConsumerState<WeekendWebview> {
  double _progress = 0;
