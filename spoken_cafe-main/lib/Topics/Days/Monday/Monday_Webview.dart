...
class MondayWebview extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MondayWebview> createState() => _MondayWebviewState();
}

class _MondayWebviewState extends ConsumerState<MondayWebview> {
  double _progress = 0;
