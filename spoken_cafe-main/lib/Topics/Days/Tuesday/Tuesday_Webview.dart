...
class TuesdayWebview extends ConsumerStatefulWidget {
  final int index; // Add an index parameter
  final int indexlevel;

  const TuesdayWebview({
    super.key,
  ...
  @override
  ConsumerState<TuesdayWebview> createState() => _TuesdayWebViewState();
}

class _TuesdayWebViewState extends ConsumerState<TuesdayWebview> {
  double _progress = 0;
