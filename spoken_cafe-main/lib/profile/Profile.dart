...
class _ProfileState extends ConsumerState<Profile> {
  ...
  Future<void> _fetchDescription() async {
    try {
      final doc = await FirebaseFirestore.instance
          .collection(widget.isTeacher ? 'teacher_description' : 'student_description')
          .doc(uid)
          .get();
  ...
  Future<void> _saveText(String description) async {
    try {
      ...
      final collectionName = widget.isTeacher ? 'teacher_description' : 'student_description';
  ...
  Future<void> _videoPicker() async {
    try {
      ...
      if (pickedFile != null) {
        ...
        String fileName = 'videos/${currentUser.uid}/${DateTime.now().millisecondsSinceEpoch}.mp4';
        final ref = FirebaseStorage.instance.ref().child(fileName);
        UploadTask uploadTask = ref.putFile(videoFile);
        TaskSnapshot snapshot = await uploadTask;
        String downloadURL = await snapshot.ref.getDownloadURL();

        DocumentReference docRef = await FirebaseFirestore.instance.collection('media').add({
    ...
    try {
      ...
      if (pickedFile != null) {
        ...
        if (_currentVideoDocId != null) {
          await FirebaseFirestore.instance.collection('media').doc(_currentVideoDocId).update({
            'url': downloadURL,
            'timestamp': FieldValue.serverTimestamp(),
          });
        } else {
              ...
              IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    PageRouteBuilder(
                      pageBuilder: (context, animation, secondaryAnimation) => const Settingsd(),
              ...
              children: [
                Padding(
                  ...
                  child: OutlinedButton(
                    ...
                    child: const Text(
                      'Edit Profile',
                      style: TextStyle(color: Color(0xff1B1212), fontWeight: FontWeight.bold),
                    ),
                  ),
                ),
                if (!isOwnProfile) ...[
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            const Text(
                              'Followers',
                              style: TextStyle(fontSize: 20, color: Color(0xff1B1212)),
                            ),
                            Text(
                              followersCount.toString(),
                              style: const TextStyle(fontSize: 17, color: Color(0xff1B1212)),
                            ),
                          ],
                        ),
                      ),
                ...
                const Text(
                  ...
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xff1B1212)),
                ),
                Column(
                  children: [
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(color: Color(0xff1B1212), width: 2),
                        ...
                        child: _uploadedVideoUrl != null && !_isVideoLoading
                            ...
                            : const Column(
                                ...
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(Icons.add, size: 40, color: Color(0xff1B1212)),
                                ],
                              ),
                      ),
                    ),
                    Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          icon: const Icon(Icons.update, color: Color(0xff1B1212)),
                        ),
                      ],
                    ),
                  ],
...
// import 'package:spokencafe/profile/Edit_Profile/Edit_Profile.dart';
// import 'package:spokencafe/profile/Help/Help.dart';
// import 'package:spokencafe/profile/image_vdieo_profile/image_video_profile.dart';
// import 'package:spokencafe/profile/settings/settings.dart';
// import 'package:video_player/video_player.dart';
// import 'package:cached_network_image/cached_network_image.dart';
// import 'package:intl/intl.dart';
// import 'package:share_plus/share_plus.dart';
// import 'package:spokencafe/Screen/Home/Home.dart';
...
//           } else if (url.toLowerCase().endsWith('.mp4')) {
//             videos.add(url);
//             if (firstVideoDocId == null) {
//               firstVideoDocId = doc.id;
...
//         imageUrls = images;
//         videoUrls = videos;
//         if (videos.isNotEmpty && _uploadedVideoUrl == null) {
//           _uploadedVideoUrl = videos.first;
//           _currentVideoDocId = firstVideoDocId;
//         }
//         _isVideoLoading = false;
//       });
...
//   StreamSubscription? _followingCountSubscription;
//   String? _uploadedVideoUrl;
//   String? _currentVideoDocId; // Store the Firestore document ID of the current video
//   final Map<String, VideoPlayerController> _videoControllers = {};
//   bool _isVideoLoading = true;
...
//         // Generate a new file name for the updated video
//         String fileName = 'videos/${currentUser.uid}/${DateTime.now().millisecondsSinceEpoch}.mp4';
//         final ref = FirebaseStorage.instance.ref().child(fileName);
//         UploadTask uploadTask = ref.putFile(videoFile);
//         TaskSnapshot snapshot = await uploadTask;
...
//         // Store the old video URL to delete it later
//         String? oldVideoUrl = _uploadedVideoUrl;
...
//         // Update videoUrls list
//         setState(() {
//           _uploadedVideoUrl = downloadURL;
//           if (videoUrls.isNotEmpty) {
//             videoUrls[0] = downloadURL; // Replace the first video
//           } else {
//             videoUrls.add(downloadURL);
//           }
//           _isVideoLoading = true;
...
//         // Delete the old video from Firebase Storage if it exists
//         if (oldVideoUrl != null) {
//           try {
//             final oldRef = FirebaseStorage.instance.refFromURL(oldVideoUrl);
//             await oldRef.delete();
...
//           videos.add(url);
//           if (firstVideoDocId == null) {
//             firstVideoDocId = doc.id; // Store the ID of the most recent video
//           }
//         }
//       }
...
//   @override
//   void dispose() {
//     // Do not dispose the controller here, as it's managed by the Profile widget
//     super.dispose();
//   }
